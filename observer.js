...
(function() {
  var InvalidBindingError, Observers, aliasDeprecatedBackboneMethods, capitalize, exports, root, _,
  ...
  aliasDeprecatedBackboneMethods = function(object) {
    object.off = object.unbind;
    return object.on = object.bind;
  };
  ...
  Observers = {
    ...
    observe: function() {
      ...
      if ((typeof Backbone !== "undefined" && Backbone !== null) && parseFloat(Backbone.VERSION) < 0.9 && !this.on) {
